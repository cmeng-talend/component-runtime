        ...
        try {
            ...
            if (valueModel != null) {
                ...
                if (result == null) {
                    ...
                    String type = null;
                    try {
                        List<SimplePropertyDefinition> properties = valueModel.getConfigurationModel().getConfigTypeNode()
                                .getProperties();
                        if (properties != null) {
                    ...
                    if (TaCoKitConst.TYPE_STRING.equalsIgnoreCase(type)) {
                        return RepositoryToComponentProperty.addQuotesIfNecessary(connection, String.class.cast(result));
                    } else {
